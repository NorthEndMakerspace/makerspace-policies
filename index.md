...
Key holders must be 18 or older. Guardians must always chaperone minors. Household minors don't require a guest pass, but may not have their own key. Any trained tools (such as a woodshop or laser cutter) would require training, as well as guardian consent to use, and may have age limits depending on their relative danger. All attendees of any age must be vaccinated.
...
- Only use tools they're trained to use.
...
Remember that this is a shared space, treat it like you live here.
