...
The CNC requires certification to use. The asynchronous learning module ([CNC 101 - Learn @ NEM](https://learn.northendmakers.org/course/view.php?id=3)) must be completed before certification.
...
1. Use the “outline” feature of gSender to ensure the cutter and router won't collide with any clamps (or manually jog the machine around).
   - It’s worth raising the endmill above any clamps or fixtures initially to avoid crashing if adjustments are needed.
...
1. Check the router RPM setting matches what's expected in your design.
...
- Don't remove the spoil board.
- Don't remove the Musclechuck. It's clocked to the spindle in a specific position to minimize runout.
- Don't change settings on the machine or in the sender.
