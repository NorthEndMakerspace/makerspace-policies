...
1. Ensure the correct bit for your cut is inserted and secure.
   * With the Musclechuck, this means tightening the bolt until finger-tight, then turn another quarter turn with the allen key. Note that overtightening risks damage to the chuck.
...
* **Fusion360 post process settings**: Post process using the "Grbl / grbl" post. In "Safe retracts and home positioning" (under "Post properties"), set "Safe retracts" to "Clearance Height".
   * If desired, G28 and G53 can also be used, but you will need to set a safe height for the G28 coordinate system.