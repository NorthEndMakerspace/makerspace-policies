...
- Currently, we do not reclaim or recycle filament scraps or remnants (the last bit of a spool). If you find a tangled or unspooled filament roll, do not use it; place it in a bag, tuck it away in a drawer, and notify the stewards on Discord.
...
- Print beds should be thoroughly cleaned with isopropyl alcohol and wipes before and after each use.
